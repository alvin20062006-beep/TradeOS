...
class TestBacktestResultFromSeries:
    def test_from_series_basic(self):
        ...
        assert len(result.positions_series) == 5
        assert result.equity_curve.iloc[0] == 1.0  # normalized to 1.0
    ...
    def test_metrics_computed(self):
        ...
        assert result.metrics["win_rate"] == 1.0  # all positive
