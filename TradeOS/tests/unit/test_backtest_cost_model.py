...
class TestCostModel:
    ...
    def test_min_cost_applied(self):
        ...
        model = CostModel(cfg)
        # 1 bps * $1,000 / 10000 = $0.10, but min = $10
    ...
    def test_turnover_rate_partial(self):
        ...
        new = pd.Series([0.5, 0.5], index=["AAPL", "GOOG"])
        delta = pd.Series([0.1, -0.1], index=["AAPL", "GOOG"])
    ...
    def test_costs_for_period(self):
        ...
        total, per_asset = model.costs_for_period(prev, new, prices, capital)

        # 10 bps * $60,000 = $60 for AAPL, 10 bps * $40,000 = $40 for GOOG
        assert total == 100.0
